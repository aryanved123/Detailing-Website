...
>
  <div className="h-[100vh] w-full relative overflow-hidden">
    ...
    <div className="relative z-20 flex flex-col items-center justify-center h-full text-white px-4 text-center select-none">
      ...
      <motion.p
        className="text-lg sm:text-xl md:text-2xl mb-8 max-w-2xl text-gray-200"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.a
        ...
        className="bg-indigo-500 hover:bg-indigo-600 text-white font-semibold px-8 py-4 rounded-full shadow-2xl transform transition hover:scale-105"
        initial={{ scale: 0.8 }}
        animate={{ scale: 1 }}
